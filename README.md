...
2. Observer Pattern: Will be Used for Game class(subject) and a GameObserver interface that will be used by our JavaFX UI. 
   Game notifies observers when events happen(move/score change) and JavaFX UI will observe and respond such as displaying the update.
